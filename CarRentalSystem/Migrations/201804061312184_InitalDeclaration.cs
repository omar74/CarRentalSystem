namespace CarRentalSystem.Migrations
{
    ...
    public partial class InitalDeclaration : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        categorytypeid_id = c.Int(),
                    })
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.Categories", t => t.categorytypeid_id)
                .Index(t => t.categorytypeid_id);
